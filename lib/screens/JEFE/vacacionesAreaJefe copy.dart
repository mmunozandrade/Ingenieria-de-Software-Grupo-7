...
class _VacacionesAreaJefeState extends State<VacacionesAreaJefe> {
  ...
  Future<void> _cargarTrabajadores() async {
    ...
    try {
      ...
      if (data['success'] == true) {
        ...
        setState(
          () => _errorTrabajadores =
              data['mensaje'] ?? 'Error al cargar trabajadores',
        );
      }
    } catch (_) {
  ...
  Future<void> _fetchHistorial(int trabajadorId) async {
    ...
    try {
      ...
      final uri = Uri.parse(
        '$_apiUrlVacJefe/jefe/vacaciones-trabajador/$trabajadorId',
      ...
      if (data['success'] == true) {
        ...
        setState(
          () =>
              _errorHistorial = data['mensaje'] ?? 'Error al cargar historial',
        );
      }
    } catch (_) {
      ...
      return const Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text(
              'No hay trabajadores en su area',
                ...
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      SizedBox(width: 6),
                      Text(
                        'Sin RUT, remuneraciones ni liquidaciones — modo lectura',
                        style: TextStyle(
                          fontSize: 11,
                          color: Color(0xFFD97706),
                        ),
