    ...
    try {
      ...
      if (data['success'] == true) {
        setState(() {
          ...
          _solicitudesPendientes = List<Map<String, dynamic>>.from(
            data['solicitudes_pendientes'] ?? [],
          );
          _enVacaciones = List<Map<String, dynamic>>.from(
            data['en_vacaciones'] ?? [],
          );
          _contratosPorVencer = List<Map<String, dynamic>>.from(
            data['contratos_por_vencer'] ?? [],
          );
        });
      } else {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_solicitudesPendientes.isEmpty)
                              _MensajeVacio(
                                texto: 'No hay solicitudes pendientes',
                              )
                            else
                            ...
                            if (_enVacaciones.isEmpty)
                              _MensajeVacio(
                                texto: 'Nadie esta de vacaciones actualmente',
                              )
                            else
                              ..._enVacaciones.map(
                                (v) => _TarjetaVacaciones(
                                  nombre: v['nombre'],
                            ...
                            if (_trabajadores.isEmpty)
                              _MensajeVacio(
                                texto: 'No hay trabajadores en el area',
                              )
                            else
                              ..._trabajadores.map(
                                (t) => _TarjetaTrabajador(
                                  nombre: t['nombre'],
                                  cargo: t['cargo'],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  '$fechaInicio - $fechaFin  |  $diasHabiles dias habiles',
                  style: const TextStyle(
                    fontSize: 12,
