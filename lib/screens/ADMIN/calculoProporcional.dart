...
const List<String> _motivos = ['Ingreso', 'Egreso'];

class CalculoProporcionalScreen extends StatefulWidget {
  const CalculoProporcionalScreen({super.key});

  @override
  State<CalculoProporcionalScreen> createState() =>
      _CalculoProporcionalScreenState();
}

class _CalculoProporcionalScreenState extends State<CalculoProporcionalScreen> {
  ...
  // Formulario
  String _motivoSeleccionado = _motivos[0];
  int _diasTrabajados = 15;
  ...
  double get _sueldoDiario {
    final sueldo = _sueldoBaseSeleccionado;
    if (sueldo == null) return 0;
    return sueldo / 30;
  }

  double get _montoEstimado => _sueldoDiario * _diasTrabajados;
  ...
  Future<void> _cargarHistorial() async {
    ...
    try {
      ...
      final data = jsonDecode(response.body);
      if (data['success'] == true) {
        setState(() => _calculos = data['calculos'] ?? []);
      }
    } catch (_) {
      // silencioso
    } finally {
  ...
  Future<void> _registrarCalculo() async {
    ...
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          ...
          'dias_trabajados': _diasTrabajados,
          'periodo': periodo,
      ...
      setState(() {
        ...
        _mensaje = _exito
            ? 'Registrado correctamente. Monto proporcional: \$${data['monto_proporcional']} CLP'
            : (data['mensaje'] ?? 'Error al registrar el calculo');
      });
      if (_exito) {
        setState(() {
          ...
          _diasTrabajados = 15;
          _motivoSeleccionado = _motivos[0];
        });
        _cargarHistorial();
      }
    } catch (_) {
  ...
  Color _colorMotivo(String motivo) =>
      motivo == 'Ingreso' ? const Color(0xFF059669) : const Color(0xFFDC2626);
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Art. 41 Código del Trabajo — para casos de ingreso o egreso durante el mes',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: _motivos.map((m) {
                          ...
                          return Expanded(
                            child: Padding(
                              ...
                              child: InkWell(
                                onTap: () =>
                                    setState(() => _motivoSeleccionado = m),
                                borderRadius: BorderRadius.circular(8),
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: seleccionado
                                        ? _colorMotivo(m).withOpacity(0.1)
                                        : Colors.white,
                                    borderRadius: BorderRadius.circular(8),
                                    border: Border.all(
                                      color: seleccionado
                      ...
                      Slider(
                        value: _diasTrabajados.toDouble(),
                        min: 1,
                        max: 30,
                        divisions: 29,
                        activeColor: const Color(0xFF001E42),
                        label: '$_diasTrabajados',
                        onChanged: (v) =>
                            setState(() => _diasTrabajados = v.round()),
                      ),
                      ...
                      if (_sueldoBaseSeleccionado != null)
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Sueldo diario: \$${_sueldoBaseSeleccionado!.toStringAsFixed(0)} ÷ 30 = \$${_sueldoDiario.toStringAsFixed(4)}',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: Color(0xFF1D4ED8),
                                ),
                              ...
                              const SizedBox(height: 6),
                              Text(
                                'Monto proporcional: \$${_sueldoDiario.toStringAsFixed(4)} × $_diasTrabajados = \$${_montoEstimado.toStringAsFixed(0)} CLP',
                                style: const TextStyle(
                                  fontSize: 13,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFF1D4ED8),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: _enviando ? null : _registrarCalculo,
                          icon: _enviando
                              ? const SizedBox(
                                  height: 18,
                                  width: 18,
                          ...
                          label: const Text('Registrar Cálculo'),
                ...
                const Text(
                  'Historial de Cálculos Proporcionales',
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: Color(0xFF001E42),
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: _colorMotivo(c['motivo']).withOpacity(0.1),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '${c['rut']} · ${c['dias_trabajados']} dias · Periodo: ${c['periodo']} · Registro: ${c['nombre_admin']}',
                                  style: const TextStyle(
                                    fontSize: 11,
